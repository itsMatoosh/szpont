...
import { BackgroundLocationGate } from '@/components/background-location-gate/background-location-gate.component';
...
export default function HomeScreen() {
  ...
  return (
    <BackgroundLocationGate
      title={t('locationGate.backgroundTitle')}
      message={t('locationGate.backgroundMessage')}
    >
